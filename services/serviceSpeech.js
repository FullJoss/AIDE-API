...
exports.playFrenchSpeech = async (texte) => {
  try {
    ...
    const result = await synthesizer(texte);
    ...
    streamSpeaker.streamAudio("sortie_audio.wav");
